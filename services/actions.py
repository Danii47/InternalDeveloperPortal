...
ACTION_SCHEMA = {
    ...
    "create_pool": {
        ...
        "params": [
            ...
            {"key": "quota_ram_mb", "label": "Cuota RAM (MB)", "type": "int", "required": False,
             "min": 1024, "max": 524288, "step": 1024, "default": 32768,
             "help": "Tope total de RAM (en MB) del pool."},
    ...
    "deploy_vms": {
        ...
        "params": [
            ...
            {"key": "bridges", "label": "Redes (VNets/Bridges)", "type": "bridge_multi", "required": True,
             "multi": True, "help": "Una o varias (coma). Varias = router/multi-NIC."},
            {"key": "cpu", "label": "vCPU", "type": "int", "required": False, "default": 2},
            {"key": "ram_mb", "label": "RAM (MB)", "type": "int", "required": False, "default": 2048},
